...
async def main():
    ...
    app = (
        ApplicationBuilder()
        .token(TOKEN)
        # JobQueue-ஐத் தனியாக உருவாக்காமல், JobQueue() என்று மட்டும் கொடுத்தால் போதும்.
        .build()
    )
    
    # 2. JobQueue-க்கு டைம்ஜோன் செட் செய்தல் (JobQueue உருவாக்கப்பட்ட பிறகு)
    # இது பழைய APScheduler சார்ந்த பதிப்புகளில் டைம்ஜோனைச் செட் செய்யச் சரியான வழி
...
if __name__ == "__main__":
    # இந்தப் பகுதிதான் பிழையை ஏற்படுத்தியிருக்கலாம்
    asyncio.run(main())