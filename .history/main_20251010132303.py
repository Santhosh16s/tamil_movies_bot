...
app.add_handler(MessageHandler(filters.ALL & ~filters.COMMAND, forward_to_group), -1)    app.add_handler(MessageHandler(filters.ALL & ~filters.COMMAND, forward_to_group))
