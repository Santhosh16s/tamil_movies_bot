...
async def post_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.text:
        # Remove /post command from text
        msg_text = update.message.text.partition(" ")[2]
        if msg_text:
            await update.message.reply_text(f"your {msg_text}")
    ...
    # Photo
        ...
        await update.message.reply_text("your photo")
        await context.bot.send_photo(chat_id=GROUP_ID, photo=update.message.photo[-1].file_id, caption=update.message.caption)

    # Video
    elif update.message.video:
        await update.message.reply_text("your video")
        await context.bot.send_video(chat_id=GROUP_ID, video=update.message.video.file_id, caption=update.message.caption)

    # Audio
    elif update.message.audio:
        await update.message.reply_text("your audio")
        await context.bot.send_audio(chat_id=GROUP_ID, audio=update.message.audio.file_id, caption=update.message.caption)

    # Document
    elif update.message.document:
        await update.message.reply_text("your document")
    ...
    # Poll
        ...
        await update.message.reply_text("your poll")
